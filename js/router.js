...
Eddie.router = {
  ...
  renderPlaybook: function(id) {
    ...
    actions += '<button class="action-btn" id="toggle-all-steps-btn" onclick="Eddie.ui.toggleAllSteps()" style="background:#e6f9f0;color:#0a8;border-color:#0a8;">&#9660; Expand All</button>';
    if (overrides[id]) {
